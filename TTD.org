...
** TODO make a method to call "splitta" as pre-processing. 
** TODO write "outer" script, for collecting all gains and related numbers. 
** TODO draw box-plot for them. 
...
*** TODO make caller without splitta 
